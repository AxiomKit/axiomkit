...
/**
 * Cost tracking using logger events
...
export class BenchMark {
   ...
   */
  getAnalytics(timeRange?: { start: number; end: number }): BenchMarkAnalytics {
 ...
 */
export function createSimpleTracker(logger: Logger): BenchMark {
  return new BenchMark(logger);
}
