...
- **[extension](/docs/api/extension#extension)** - Create extension bundles
- **[Extension Components](/docs/api/extension#components)** - Contexts, actions, services
- **[Extension Lifecycle](/docs/api/extension#lifecycle)** - Loading and initialization
...
```typescript
interface Config<TContext extends AnyContext = AnyContext> {
  model: LanguageModel;
  modelSettings?: ModelSettings;
  extensions?: Extension[];
  contexts?: Context<TContext>[];
  actions?: Action[];
  memory?: MemorySystem;
  logger?: Logger;
