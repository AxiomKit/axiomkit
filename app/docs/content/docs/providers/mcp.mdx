  ...
  "mcpServers": {
    ...
    "command": "npx",
      "args": [
        "-y",
        "tsx",
        "/Users/karas/Desktop/Dev Karas/axiomkit/app/examples/mcp/mcp-simple-server.ts"
      ],
      "env": {
        "PATH": "/Users/karas/.nvm/versions/node/v20.16.0/bin:/usr/local/bin:/usr/bin:/bin" // Example Config of Nodejs Path
      }
    },
